...
export default function MembersPage() {
  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6">
      <Header stats={stats} refreshMembers={refreshMembers} isLoading={isLoading} searchQuery={searchQuery} setSearchQuery={setSearchQuery} statusFilter={statusFilter} setStatusFilter={setStatusFilter} />
